'''
Find the LLJs for selected months
'''
# Import packages
import glob
import datetime
...
nwf_data_dir_2019 = "/pl/active/WRFLES_GAD/N_Atl/reruns_Beiter/wrfouts/ca_100_tke/2019/"
nwf_data_dir_2020 = "/pl/active/WRFLES_GAD/N_Atl/reruns_Beiter/wrfouts/ca_100_tke/2020/"
...
for period in range(0, 41):  # there are 41 three day period in 4 months
    # select a 72 hour long period
    nwf_files = nwf_files_all[period*72:(period*72)+72]
    ...
    df.to_csv(f'CA100_long_island_dfs/detect_{period:02}.csv')
